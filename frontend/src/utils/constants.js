...
export const createDefaultEmpresa = () => ({
  codigoBanco: "237",
  tipoInscricao: "2",
  cnpj: "",
  convenio: "",
...
export const createDefaultLote = () => ({
  tipoServico: "20",
  formaLancamento: "41",
...
export const createDefaultPagamento = () => ({
  bancoFavorecido: "",
  agenciaFavorecido: "",
  dvAgenciaFav: "0",
  contaFavorecido: "",
...
export const defaultEmpresa = createDefaultEmpresa();

export const defaultLote = createDefaultLote();

export const defaultPagamento = createDefaultPagamento();

export const tipoChavePixOptions = [
  { value: "01", label: "01 - CPF / CNPJ" },
  { value: "02", label: "02 - E-mail" },
  { value: "03", label: "03 - Celular" },
  { value: "04", label: "04 - Chave Aleatoria (EVP)" },
];
...
export const tooltips = {
  ...
  tipoChavePix: "Tipo da chave PIX: 1=CPF, 2=CNPJ, 3=Email, 4=Telefone, 5=Aleatoria (EVP)",
  chavePix: "Chave PIX do favorecido (CPF/CNPJ, email, telefone ou chave aleatoria)",
  txIdPix: "Identificador da transacao PIX (end-to-end ID). Opcional",
  codBarrasPix: "Codigo de barras ou QR-Code PIX Copia e Cola (forma 47)",
